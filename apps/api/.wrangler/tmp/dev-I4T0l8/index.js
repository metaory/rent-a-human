...
// .wrangler/tmp/bundle-srt4tM/strip-cf-connecting-ip-header.js
...
var bookings = [];
var reviews = [];
var genId = /* @__PURE__ */ __name((prefix) => `${prefix}-${Date.now().toString(36)}`, "genId");
...
app.get(
  "/reviews/agent/:id",
  (c) => c.json(reviews.filter((r) => r.agentId === c.req.param("id")))
);
...
// .wrangler/tmp/bundle-srt4tM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-srt4tM/middleware-loader.entry.ts
